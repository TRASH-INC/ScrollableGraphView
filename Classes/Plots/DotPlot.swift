...
open class DotPlot : Plot {
    ...
    open var dataPointFillColor: CGColor =  CGColor(colorSpace: CGColorSpaceCreateDeviceRGB(), components: [0.0,0.0, 0.0, 1.0])!
    ...
    open var customDataPointPath: ((_ centre: CGPoint) -> CGMutablePath)?
